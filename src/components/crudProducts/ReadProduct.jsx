...
const ReadProduct = ({ inforProduct }) => { // Formulario donde el administrador puede ver los detalles de un producto
    const { _id, title, description, price, image, stock, created_at, udated_at } = inforProduct
    ...
    return (
        <div className='m-5 h-96 flex border border-black rounded-sm items-center max-md:flex-col max-md:h-auto max-md:gap-y-5 max-md:p-5'>
            ...
            <div className='w-[60vw] max-lg:w-[55vw] h-full px-2 flex flex-col justify-evenly max-md:w-full'>
                ...
                <p><span className='font-semibold'>Actualizado el </span>{udated_at}</p>
